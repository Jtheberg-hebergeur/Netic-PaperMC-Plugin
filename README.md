...
🔑 API Netic sécurisée : Chaque serveur utilise sa propre clé API (à obtenir sur netic.jtheberg.cloud ).

Installation :

Téléchargez et placez le plugin dans votre dossier plugins.

Remplissez votre clé API dans config.yml.

Configurez les options selon vos besoins (nom de l’IA, trigger, délai, type de base de données).

Redémarrez votre serveur et utilisez la commande de chat pour parler à Netic.
